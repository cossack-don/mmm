...
const data = ref([
  ['', '', '', '', '', '', ''],
  ['', '', '', '', '', 'ИИС3 (FRIZ) - 1.250.000', 'из 3.000.000'],
  ['', '', '', '', 'Брокер счет 2.600.000', 'из 6.000.000', '30% + 55% + 15%'],
  [
    '',
    '',
    '',
    'Вклады 500.000',
    'из 1.000.000',
    'Разбить на 300 + 100 + 100',
    '',
  ],
  ['', '', 'Резерв счет 200.000', 'из 200.000', '', '', ''],
  ['', 'Кредитка 980.000', 'из 1.000.000', '', '', '', ''],
  ['Наличные 200.000', 'из 200.000', ' + 300 $ лежит', '', '', '', ''],
]);
